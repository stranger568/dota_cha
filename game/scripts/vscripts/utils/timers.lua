...
function Timers:CreateTimer(name, args)
  if type(name) == "function" then
    args = {callback = name}
    name = DoUniqueString("timer")..DoUniqueString("timer2")..DoUniqueString("timer3")..DoUniqueString(tostring(RandomInt(1000,9999)))..DoUniqueString(tostring(RandomInt(1000,9999)))
