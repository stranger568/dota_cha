modifier_skill_multicast = class({})

function modifier_skill_multicast:IsHidden() return true end
function modifier_skill_multicast:IsPurgable() return false end
function modifier_skill_multicast:IsPurgeException() return false end
function modifier_skill_multicast:RemoveOnDeath() return false end
function modifier_skill_multicast:AllowIllusionDuplicate() return true end
...
if IsServer() then
	function modifier_skill_multicast:OnAbilityExecutedCustom(keys)
		...
		if multicast then
			PreformMulticast(caster, castedAbility, multicast, 0.35, target)
		end
	end
	...
	local MULTICAST_ABILITIES = {
		...
		vengefulspirit_magic_missile_custom = MULTICAST_TYPE_SAME,
		...
		item_book_of_strength_custom = MULTICAST_TYPE_NONE,
		item_book_of_agility_custom = MULTICAST_TYPE_NONE,
		item_book_of_intelligence_custom = MULTICAST_TYPE_NONE,     
        ...
        item_tier1_token_custom = MULTICAST_TYPE_NONE,
        item_tier2_token_custom = MULTICAST_TYPE_NONE,
        item_tier3_token_custom = MULTICAST_TYPE_NONE,
        item_tier4_token_custom = MULTICAST_TYPE_NONE,
        item_tier5_token_custom = MULTICAST_TYPE_NONE,
        item_tier5_token_roshan_custom = MULTICAST_TYPE_NONE,
	}
