modifier_skill_lifestealer = class({})

function modifier_skill_lifestealer:IsHidden() return true end
function modifier_skill_lifestealer:IsPurgable() return false end
function modifier_skill_lifestealer:IsPurgeException() return false end
function modifier_skill_lifestealer:RemoveOnDeath() return false end
function modifier_skill_lifestealer:AllowIllusionDuplicate() return true end

function modifier_skill_lifestealer:TakeDamageScriptModifier(params)
...
function modifier_skill_lifestealer:FlagExist(a,b)
	local p,c,d=1,0,b
